  ...
  'py2exe': { "includes" : ["matplotlib.backends.backend_tkagg", "tkMessageBox"],
                ...
                'excludes': ['_gtkagg', '_tkagg', '_agg2', '_cairo', '_cocoaagg', "matplotlib.numerix.fft","sip", "PyQt4._qt",
                              "matplotlib.backends.backend_qt4agg",
                               "matplotlib.numerix.linear_algebra", "matplotlib.numerix.random_array", '_fltkagg', '_gtk','_gtkcairo' ],
...
setup (windows = [{"script" : "ReadPlotCsv.py"}], options = opts,   data_files = matplotlib.get_py2exe_datafiles())
